...
pub mod i_land_nft {
    ...
    impl<M> std::fmt::Debug for ILandNFT<M> {
    ...
    impl ethers::core::abi::AbiDecode for ILandNFTCalls {
        fn decode(
            ...
            {
                return Ok(ILandNFTCalls::SafeTransferFromWithFromAndToAndData(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for ILandNFTCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                ILandNFTCalls::SafeTransferFromWithFromAndToAndData(element) => element.encode(),
    ...
    impl ::std::fmt::Display for ILandNFTCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                ILandNFTCalls::SafeTransferFromWithFromAndToAndData(element) => element.fmt(f),
    ...
    impl ::std::convert::From<SafeTransferFromWithFromAndToAndDataCall> for ILandNFTCalls {
        fn from(var: SafeTransferFromWithFromAndToAndDataCall) -> Self {
            ILandNFTCalls::SafeTransferFromWithFromAndToAndData(var)
        }
    }
